...
int spi_flash_cmd_erase_ops(struct spi_flash *flash, u32 offset, size_t len)
{
	...
	printf("======**=====spi_flash_cmd_erase_ops1:%d %d %d=======***========\n", flash->erase_size, offset, (int)len);
	erase_size = flash->erase_size;
	if ((int)len < erase_size) len = (size_t)erase_size;
	
	if (offset % erase_size || len % erase_size) {
		debug("SF: Erase offset/length not multiple of erase size\n");
		return -1;
	}
	printf("===========spi_flash_cmd_erase_ops2===============\n");
	...
	while (len) {
		...
		printf("===========spi_flash_cmd_erase_ops3===============\n");
		...
		printf("===========spi_flash_cmd_erase_ops4===============\n");
